...
class m150414_195800_timeline_event extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(
            ...
            [
                ['frontend', 'user', 'signup', json_encode(['public_identity' => 'systemadmin', 'user_id' => 1, 'created_at' => time()]), time()],
                ['frontend', 'user', 'signup', json_encode(['public_identity' => 'admin', 'user_id' => 2, 'created_at' => time()]), time()],

...
class m150725_192740_seed_data extends Migration
{
    ...
    public function safeUp()
    {
        $this->insert('{{%user}}', [
            ...
            'password_hash' => Yii::$app->getSecurity()->generatePasswordHash('systemadmin'),
        ...
        $this->insert('{{%key_storage_item}}', [
            ...
            'value' => 'skin-blue',
            'comment' => 'skin-blue, skin-black, skin-purple, skin-green, skin-red, skin-yellow, skin-blue-light, skin-black-light, skin-red-light, skin-yellow-light, skin-purple-light, skin-green-light'
        ]);
        ...
        $this->insert('{{%key_storage_item}}', [
            ...
            'value' => 'enabled',
            'comment' => 'Set it to "disabled" to turn on maintenance mode'
        ]);
